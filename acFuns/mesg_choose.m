...
%[out,idx] = sort(Xgrid);
%
%csvwrite('plot/mes-gacq.csv', [Xgrid(idx) acfun(Xgrid(idx))]); 
%csvwrite('plot/meanvar.csv', [Xgrid(idx) meanVector(idx), varVector(idx)]);
%csvwrite('plot/obs.csv', [xx yy]); 
%csvwrite('plot/maxvals.csv', maxes'); 
